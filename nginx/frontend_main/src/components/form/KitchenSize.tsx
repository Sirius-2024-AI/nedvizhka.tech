...
const KitchenSize: React.FC<KitchenSizeProps> = ({
  size,
  onSizeChange,
  ...
  return (
    <>
      <div className="text-4xl font-bold text-white max-md:max-w-full leading-none">
        <span className="font-mabry leading-none">площадь кухни</span>
      </div>
