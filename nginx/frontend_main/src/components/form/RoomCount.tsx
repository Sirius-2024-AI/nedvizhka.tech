...
const RoomCount: React.FC<RoomCountProps> = ({ count, onCountChange, permissionForNextStep }) => {
  return (
    <>
      <div className="text-4xl font-bold text-white max-md:max-w-full leading-none">
        <span className="font-mabry leading-none">количество комнат в квартире</span>
      </div>
